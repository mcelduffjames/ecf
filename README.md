...
4. Thursday: Working on completing the Action Resolution Dashboard. Figured out the error in the load script - needed to do `num#(OfficeNumber) AS OfficeNumber` in order for the keys to match up. Still working for the bar chart within table and to get and better understand the date filter. 

...
2. Tuesday: Time towards cleaning up data model - is the SubRequests table needed? Support Center uses 41.000 rows of data. Beginning the Home Lending Ops migration.

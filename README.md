...
5. Friday: Worked more on the global filter for active vendors on Rate Plan Surveillance. Used the QVPR Analyzer to start to create a time table of the reload tasks.
